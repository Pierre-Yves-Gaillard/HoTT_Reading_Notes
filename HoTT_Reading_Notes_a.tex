...
Let us spell out the proof of the contractibility of $\lV\fib_f(f(a))\rV_n$: Lemma 7.3.15 implies 
$$
\lV\lV\fib_f(f(a))\rV_n\rV_0=\lV\fib_f(f(a))\rV_0,
$$ 
and the first part of the proof shows that $\lV\fib_f(f(a))\rV_0$ is contractible. $\sq$
