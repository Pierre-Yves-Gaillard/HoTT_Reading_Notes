...
$$ 
In other words, abbreviating $\tr^{\hat\code}$ by $\ms t$, $\me$ by $\ms m$, $\pa$ by $\ms p$, $\refl$ by $\ms r$, we get 
$$
\ms t\Bigg(\ms p\bigg(\ms m(x_1)\cc\ms m(x_0)^{-1},\al\Big(\ms m(x_1)\cc\ms m(x_0)^{-1},\ms r_N\Big)\bigg),\bigg\lv(x_0,\bet)\bigg\rv_{2n}\Bigg)
$$ 
$$
=\ms t\Bigg(\ms p\bigg(\ms m(x_0)^{-1},\al\Big(\ms m(x_0)^{-1},\ms m(x_1)\Big)\bigg),\ms t\bigg(\ms p\Big(\ms m(x_1),\al\big(\ms m(x_1),\ms r_N\big)\Big),\Big\lv(x_0,\bet)\Big\rv_{2n}\bigg)\Bigg)
$$ 
...
$$\lv(x_0,\bet)\rv_{2n}:\code(N,\ms r_N),$$ 

$$\ms p\bigg(\ms m(x_1)\cc\ms m(x_0)^{-1},\al\Big(\ms m(x_1)\cc\ms m(x_0)^{-1},\ms r_N\Big)\bigg):(N,\ms r_N)=(N,\ms m(x_1)\cc\ms m(x_0)^{-1}),$$

$$\ms p\bigg(\ms m(x_1),\al\Big(\ms m(x_1),\ms r_N\Big)\bigg):(N,\ms r_N)=(S,\ms m(x_1)),$$
