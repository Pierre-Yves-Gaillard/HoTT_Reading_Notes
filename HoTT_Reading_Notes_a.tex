...
$$ 
(Recall that $\ishae(f)$ stands for ``$f$ is a half-adjoint equivalence''.) By Theorem 4.2.3 and the comment preceding it, there are dependent functions 
$$
...
To prove the equality $\ms{merid}_\star(\tau(N))=\tau(S)$, one can use the following lemma:
