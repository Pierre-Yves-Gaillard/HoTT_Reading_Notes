...
The claim ``since $\mathbb Z$ is a set, $\Omega^{n-1}(\mathbb Z)$ is contractible'' follows from Theorems 7.1.7 and 7.2.7.

%%

\subsection{Proof of Theorem 8.2.1}

The equality $\lVert\lVert A\rVert_{n+1}\rVert_n=\lVert A\rVert_n$ follows from Theorem 7.1.7 and Lemma 7.3.3.
