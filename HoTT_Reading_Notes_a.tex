...
$$ 
hold, and $d(\mbf2,c)$ is propositionaly equal to the nonidentity automorphism. Then there is a family $f:\prod_{A:\U}A\to A$ such that $f(\mbf2)=d(\mbf2,c)$. %$\prod_{A:\mathcal U}A\to A$ is not contractible.
