...
The proof uses implicitly the fact that $A/\!\!/R$ is a set. This fact follows immediately from Theorem 7.1.8 of the book. The reader can check that the proof of Theorem 7.1.8 doesn't use Theorem 6.10.6.
