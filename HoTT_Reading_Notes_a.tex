...
Suppose first $<$ is well-founded, and suppose $B:\mc P(A)$ is a nonempty subset with no minimal element. That is, for any $a:A$ with $a\in B$, there merely exists a $b:A$ with $b<a$ and $b\in B$. It suffices to prove $\mbf0$. 
...
B:\eq\{a:A\ |\ \neg\acc(a)\}
$$ 
is nonempty. It suffices to prove $\mbf0$. We can assume that a minimal element $a_0$ of $B$ exists purely. As in the first part of the proof, it suffices to find an 
$$
