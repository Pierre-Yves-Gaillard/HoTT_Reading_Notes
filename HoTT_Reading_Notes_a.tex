...
$$ 
then the resulting quotient of $\sum_{a:A}B(a)$ satisfies
\begin{equation}\label{1011}
\left(\sum_{a:A}B(a)\right)\!\!\!\Bigg/\!\!\!\!\sim\ \ =\sum_{a:A}\ \lV B(a)\rV.
\end{equation}

To prove \eqref{1011}, it suffices, by Lemma 4.8.2 of the book, to note that the left and right hand sides have the same induction principle (see \S\ref{610}). $\square$
