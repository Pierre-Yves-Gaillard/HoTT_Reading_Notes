...
$$ 
for $f,g:A\to B$ is defined in the obvious way by path induction. If 
$$
e:A\to(A\to B)\to B
$$ 
is the evaluation, \emph{i.e.} $e(a,f)\de f(a)$, then we have, again by path induction, 
$$
\msf{happly}(p)(a)=\msf{ap}_{e(a)}(p)
$$ 
for $p:f=g$ and $a:A$. 
