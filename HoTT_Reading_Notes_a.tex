...
$$
u\equiv(\refl_x)_*(u)=p(x,x)_*(u)=v,
$$ 
the second and third paths being respectively $\msf{ap}_{s\mapsto s_*(u)}(r)$ and $q(x,x,u,v)$. This proves ($*$). The other implication is clear.
