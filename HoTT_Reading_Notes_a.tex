...
\nn\emph{Proof.} Equivalence (a) follows from Exercise 2.10 (see \S\ref{210} p.~\pageref{210}). As Lemma 3.11.8 implies that $\sum_{a:A}(a=x)$ is contractible with center $(x,\refl_x)$, Equivalence (b) follows from Lemma 3.11.9(ii). $\square$
...
\nn where (a) and (b) follow from Exercise 2.10 (see \S\ref{210} p.~\pageref{210}), and (c) follows from Lemmas 3.11.8 and 3.11.9(ii).
