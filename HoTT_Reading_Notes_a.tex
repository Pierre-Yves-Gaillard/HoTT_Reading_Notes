...
If we have $P:\prod_{a:A}\acc(a)\to\U$ and $f$ as in \eqref{1032}, then we get 
$$
g:\prod_{a:A}\acc(a)\to P(a)
$$ 
with
$$
g(a,\acc_<(a,\pr_1\ci u))\eq f(a,\pr_1\ci u,\lambda b.\lambda l.g(b,\pr_1u(b,l)))
$$
for all $a:A$ and all $u:\prod_{b:A}(b<a)\to\acc(b)\times P(b)$.

Here is a first particular case:
