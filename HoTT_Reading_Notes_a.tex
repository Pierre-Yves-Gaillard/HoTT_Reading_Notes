...
To prove Lemma 9.3.2 the following two lemmas might be useful. (Lemma~1 below is a mild generalization of Lemma 9.2.8.)

\nn\tb{Lemma 1.} \emph{In the diagram below, $A,B,C,D$ are categories; $F,G:A\to B$, $H,K:C\to D$ and $L:B\to C$ are functors; $\gamma:F\to G$ and $\delta:H\to K$ are natural transformations:
$$
\xymatrix{
...
$$ 
\tb{Lemma 2.} \emph{In the diagram below, $A,B,C,D$ are categories; $F:A\to B$, $G,H,K:B\to C$ and $L:C\to D$ are functors; $\alpha:G\to H$ and $\beta:H\to K$ are natural transformations:
$$
\xymatrix{
&&&\ar[ll]_K\\ \\
