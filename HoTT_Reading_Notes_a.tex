...
$$ 
it suffices, by induction, to define 
$$
...
$$ 
and to set $\msf{decode}(\lvert x\rvert_{n+1},\lvert y\rvert_{n+1})\de g(x,y)$. To define $g$ it suffices, by recursion, to define 
$$
h:\prod_{x,y:A}(x=y)\to(\lvert x\rvert_{n+1}=\lvert y\rvert_{n+1})
$$ 
and to set $g(x,y)(\lvert p\rvert_n)\de h(x,y)(p)$. Finally, we define $h$ by 
$$
h(x,y)(p)\de\msf{ap}_{\lvert-\rvert_{n+1}}(p).
$$
