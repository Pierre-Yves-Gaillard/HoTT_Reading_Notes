...
\section{Section 2.14.1}

\subsection{Use of Theorem 2.7.4}
...
Suppose $f:\msf{isSet}(A)$; then for any $x,y:A$ and $p,q:x=y$ we have $f(x,y,p,q):p=q$. Let $q':x=y$ and $r:q=q'$. We prove  
$$
f(x,y,p,q)\cdot r=f(x,y,p,q')
$$ 
by path induction on $r$. This implies 
$$
r=f(x,y,p,q)^{-1}\cdot f(x,y,p,q').
$$ 
In particular, $r$ depends only, up to definitional equality, on $x,y,p,q$ and $q'$.
