...
\nn\emph{Solution.} We define $f:\neg(P+\neg P)\to\mbf0$ by 
$$
f(g):\equiv (g\circ\inr)(g\circ\inl).
$$ 
This makes sense because $g\circ\inr:\neg P\to\mbf0$ and $g\circ\inl:\neg P$.

Slightly different phrasing: Compose the natural maps
\begin{align*}
\neg(P+\neg P)\to\ &(\neg P\times\neg\neg P)\\
                   &(\neg P\times\neg\neg P)\to\mbf0.
\end{align*}
