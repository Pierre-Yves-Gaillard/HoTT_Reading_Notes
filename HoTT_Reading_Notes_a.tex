...
(There is a short reminder of the induction principle for $\N$ at the end of this section.) 
...
$$
f:\eq \ind_\N\bigg(C',g,\la m.\la x.\ind_\N\Big(C'\big(\su(m)\big),h(m),\la n.\la y.k\big(m,n,x(n)\big)\Big)\bigg).
$$
