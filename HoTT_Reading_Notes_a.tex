...
Note that the equality $(\delta LG)(HL\gamma)=(KL\gamma)(\delta LF)$ we have just proved can be illustrated by the commutative square 
$$
\xymatrix{
...
In the notation of \S\ref{928} above, the following diagrams and equalities may help the reader:
