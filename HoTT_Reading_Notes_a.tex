...
\nn\emph{Proof.} Equivalence (a) follows from Exercise 2.10 (see \S\ref{210} p.~\pageref{210}). As Lemma 3.11.8 (see \S\ref{311} p.~\pageref{311}) implies that $\sum_{a:A}(a=x)$ is contractible with center $(x,\refl_x)$, Equivalence (b) follows from Lemma 3.11.9(ii) (see \S\ref{311} p.~\pageref{311}). $\square$
