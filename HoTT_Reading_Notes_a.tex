...
\emph{Statement.} Show that if we define $A+B:\equiv\sum_{x:\mathbf2}\rec_{\mathbf2}(\U,A,B,x)$, then we can give a definition of $\ind_{A+B}$ for which the definitional equalities stated in \S1.7 hold.

\nn\emph{Solution.} We define $\inl:A\to A+B$ by $\inl(a):\equiv(0_{\mathbf2},a)$, and we define $\inr$ similarly. Let $C:A+B\to\U$ be given, and put 
$$
...
$$
We define $D:\mathbf2\to\U$ by 
$$
D(n):\equiv\prod_{u:\rec_{\mathbf2}(\U,A,B,n)}C(n,u).
$$ 
Note that $D(0_{\mathbf2})\equiv A'$ and $D(1_{\mathbf2})\equiv B'$. Recall that 
$$
\ind_{\mathbf2}(D):D(0_{\mathbf2})\to D(1_{\mathbf2})\to\prod_{n:\mathbf2}D(n).
$$ 
In particular we have 
$$
\ind_{\mathbf2}(D,g_0,g_1):\prod_{n:\mathbf2}\ \prod_{u:\rec_{\mathbf2}(\U,A,B,n)}C(n,u).
$$ 
Since 
$$
\ind_{\sum_{n:\mathbf2}\rec_{\mathbf2}(\U,A,B,n)}(C):\left(\prod_{n:\mathbf2}\ \prod_{u:\rec_{\mathbf2}(\U,A,B,n)}C(n,u)\right)\to\prod_{x:A+B}C(x),
$$ 
we can set 
$$
\ind_{A+B}(C,g_0,g_1):\equiv\ind_{\sum_{n:\mathbf2}\rec_{\mathbf2}(\U,A,B,n)}(C,\ind_{\mathbf2}(D,g_0,g_1)).
$$ 
We must check 
\begin{equation}\label{15a}
\ind_{A+B}(C,g_0,g_1,(0_{\mathbf2},a))\equiv g_0(a),
\end{equation}
\begin{equation}\label{15b}
\ind_{A+B}(C,g_0,g_1,(1_{\mathbf2},b))\equiv g_1(b).
\end{equation} 
We have 
\begin{align*}
\ind_{A+B}(C,g_0,g_1,(0_{\mathbf2},a))&\equiv\ind_{\sum_{n:\mathbf2}\rec_{\mathbf2}(\U,A,B,n)}(C,\ind_{\mathbf2}(D,g_0,g_1)\\ 
&\equiv\ind_{\mathbf2}(D,g_0,g_1)(0_{\mathbf2})(a)\\ 
&\equiv g_0(a),
\end{align*}
the three definitional equalities following respectively from the definitions of the dependent functions
$$
\ind_{A+B},\quad\ind_{\sum_{n:\mathbf2}\rec_{\mathbf2}(\U,A,B,n)},\quad\ind_{\mathbf2}.
$$ 
