...
$$ 
Set $T:\equiv\rec_{\mathbf2}(\U,A,B):\mathbf2\to\U$. We define $D:\mathbf2\to\U$ by 
$$
...
$$
\ind_{\mathbf2}(D,g_0,g_1):\prod_{n:\mathbf2}\ \prod_{u:T(n)}C(n,u).
$$ 
Since 
$$
\ind_{\sum_{n:\mathbf2}T(n)}(C):\left(\prod_{n:\mathbf2}\ \prod_{u:T(n)}C(n,u)\right)\to\prod_{x:A+B}C(x),
$$ 
we can put 
$$
\ind_{A+B}(C,g_0,g_1):\equiv\ind_{\sum_{n:\mathbf2}T(n)}(C,\ind_{\mathbf2}(D,g_0,g_1)).
$$ 
We must check 
...
We have 
\begin{align*}
\ind_{A+B}(C,g_0,g_1,(0_{\mathbf2},a))&\equiv\ind_{\sum_{n:\mathbf2}T(n)}(C,\ind_{\mathbf2}(D,g_0,g_1)\\ 
...
$$
\ind_{A+B},\quad\ind_{\sum_{n:\mathbf2}T(n)},\quad\ind_{\mathbf2}.
$$ 
