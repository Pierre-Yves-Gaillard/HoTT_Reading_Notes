...
$$
v(\alpha):\eq\fu\Big(\la a'\ .\ r(a')\cd k\big((p^{-1})_\star\ a'\big)\cd\alpha\big((p^{-1})_\star\ a'\big)\cd s(a')\Big).
$$ 
...
The path 
$$
r(a')\cd k\big((p^{-1})_\star\ a'\big)\cd\alpha\big((p^{-1})_\star\ a'\big)\cd s(a'):\ms t^{B'}(p,f)(a')=g(a')
$$ 
...
by 
$$
u(f,a):\eq(a,f(a)),\quad v(g)(a,b):\eq\pr_2(g(a))(a)^{-1}\cdot\pr_2(g(a))(b).\ \sq
$$
...
\nn\emph{Proof.} Equivalence (a) follows from Exercise 2.10. As Lemma 3.11.8 implies that 
$$
\sum_{a:A}\ (a=x)
$$ 
