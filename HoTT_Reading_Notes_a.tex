...
$$
\msf{LEM}':\prod_{A:\U}\isProp(A)\to\big((A=\mbf1)+(A=\mbf0)\big)
$$ 
...
f:\prod_{A:\U}A\to A
$$ 
by $f(A)\de e(\msf{lem}(P(A),b(A)))$. The equality $\msf{lem}(P(\mbf2),b(\mbf2))=\inl(c)$, which is easily checked, implies  
$$
f(\mbf2)\de e(\msf{lem}(P(\mbf2),b(\mbf2))=e(\inl(c))=d(\mbf2,c).\ \square 
$$ 
