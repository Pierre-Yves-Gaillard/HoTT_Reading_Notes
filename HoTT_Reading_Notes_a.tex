...
The type $\isContr(C)$ being a mere proposition by Lemma 3.11.4, to define $f(A)$ it suffices to define a map $g:\isProp(\isContr(C))\to A\to A$. Since we have 
$$
...
The equality 
$$
\LEM\big(P(\mb2),b(\mb2)\big)\ =_{P(\mb2)+\neg P(\mb2)}\ \inl(c),
$$ 

\nn which follows from Exercise~3.6 (see \S\ref{e36} p.~\pageref{e36} above), implies  

$$
f(\mb2):\eq e\Big(\mb2,\LEM\big(P(\mb2),b(\mb2)\big)\Big)=e(\mb2,\inl(c))=d(\mb2,c).\ \square 
$$ 
